    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        item[position].let {
            when (item[0].langCode) {
                0 -> holder.itemView.tvMenuName.text = it.dicKor
                1 -> holder.itemView.tvMenuName.text = it.dicEn
                2 -> holder.itemView.tvMenuName.text = it.dicChb
                3 -> holder.itemView.tvMenuName.text = it.dicJpe
            }
            holder.bind(it)
        }
    }
